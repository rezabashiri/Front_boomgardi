                        ...
                        <Card>
                            <CardBody className="pt-5 pb-5 d-flex flex-lg-column flex-md-row flex-sm-row flex-column">
                                <div className="price-top-part">
                                    ...
                                    <p className="text-large mb-2 text-default">11000 تومان</p>
                                ...
                                <div className="pl-3 pr-3 pt-3 pb-0 d-flex price-feature-list flex-column flex-grow-1">
                                    ...
                                    <div>
                                        <NavLink to="/auth-login" className="btn btn-link btn-empty btn-lg">
                                            <IntlMessages id="lp.pricetable.purchase" /> <i className="simple-icon-arrow-left"></i>
                                        </NavLink>
                                    </div>
                                </div>
                            </CardBody>
                        ...
                        <Card>
                            <CardBody className="pt-5 pb-5 d-flex flex-lg-column flex-md-row flex-sm-row flex-column">
                                <div className="price-top-part">
                                    ...
                                    <p className="text-large mb-2 text-default">17000 تومان</p>
                        ...
                        <Card>
                            <CardBody className="pt-5 pb-5 d-flex flex-lg-column flex-md-row flex-sm-row flex-column">
                                <div className="price-top-part">
                                    ...
                                    <p className="text-large mb-2 text-default">19000 تومان</p>
