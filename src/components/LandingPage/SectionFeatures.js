        ...
        return (
            <Fragment>
                ...
                <Row className="featur1e-row">
                    ...
                    <Colxx xxs={{ size: 12, order: 1 }} md={{ size: 6, offset: 0, order: 1 }} lg={{ size: 5, offset: 1 }} className="d-flex align-items-center">
                        <div className="d-flex">
                            <div className="feature-text-container">
                    ...
                    <Colxx xxs={{ size: 12, order: 2 }} md={{ size: 6, order: 2 }} lg="6">
