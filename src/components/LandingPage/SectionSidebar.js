                ...
                <div className="side-bar-content">
                    ...
                    <Card className="flex-row mb-4">
                        <div className="w-30 position-relative">
                            ...
                            <span className="badge badge-pill badge-theme-1 position-absolute badge-top-right">جدید</span>
                        </div>
                    ...
                    <Card className="flex-row mb-4">
                        <div className="w-30 position-relative">
                            ...
                            <span className="badge badge-pill badge-theme-2 position-absolute badge-top-right">بروز شده</span>
                        </div>
                        <div className="w-70 d-flex align-items-center">
                            <CardBody>
                                <NavLink to="/blog-detail">
