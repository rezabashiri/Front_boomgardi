                        ...
                        <Card className="flex-row mb-5 listing-card-container">
                            ...
                            <div className="w-60 d-flex align-items-center">
                                <CardBody>
                                    ...
                                    <footer>
                                        <p className="text-muted text-small mb-0 font-weight-light">18 بهمن 1397</p>
                                    </footer>
                                </CardBody>
                            </div>
                        </Card>
                        ...
                        <Card className="flex-row mb-5 listing-card-container">
                            ...
                            <div className="w-60 d-flex align-items-center">
                                <CardBody>
                                    ...
                                    <footer>
                                        <p className="text-muted text-small mb-0 font-weight-light">27 مرداد 1395</p>
                                    </footer>
                                </CardBody>
                            </div>
                        </Card>
                        ...
                        <Card className="flex-row mb-5 listing-card-container">
                            ...
                            <div className="w-60 d-flex align-items-center">
                                <CardBody>
                                    ...
                                    <footer>
                                        <p className="text-muted text-small mb-0 font-weight-light">15 مهر 1395</p>
                                    </footer>
                                </CardBody>
                            </div>
                        </Card>
                        ...
                        <Card className="flex-row mb-5 listing-card-container">
                            ...
                            <div className="w-60 d-flex align-items-center">
                                <CardBody>
                                    ...
                                    <footer>
                                        <p className="text-muted text-small mb-0 font-weight-light">18 شهریور 1364</p>
                                    </footer>
                                </CardBody>
                            </div>
                        </Card>
