                    ...
                    <Colxx xxs="12">
                      ...
                      <Card className="d-flex flex-row mb-3">
                        <div className="d-flex flex-grow-1 min-width-zero">
                          <CardBody className="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                            ...
                            شروع کار با تم Dore Admin
                            </NavLink>
                            <p className="mb-1 text-muted text-small w-15 w-xs-100">15 آبان 1397</p>
                            <div className="w-20 w-xs-100 align-self-center d-flex justify-content-start justify-content-md-end">
                              <Badge pill color="secondary">مبتدی</Badge>
                            </div>
                          </CardBody>
                        </div>
                      </Card>
                      ...
                      <Card className="d-flex flex-row mb-3">
                        <div className="d-flex flex-grow-1 min-width-zero">
                          <CardBody className="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                            <NavLink className="list-item-heading mb-1 w-60 w-xs-100" to="/docs-detail">
                              پلاگین ها و کتابخانه ها
                            </NavLink>
                            <p className="mb-1 text-muted text-small w-15 w-xs-100">25 آذر 1397</p>
                            <div className="w-20 w-xs-100 align-self-center d-flex justify-content-start justify-content-md-end">
                              <Badge pill color="secondary">مبتدی</Badge>
                            </div>
                          </CardBody>
                      ...
                      <Card className="d-flex flex-row mb-3">
                        <div className="d-flex flex-grow-1 min-width-zero">
                          <CardBody className="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                            ...
                            <p className="mb-1 text-muted text-small w-15 w-xs-100">25 آذر 1397</p>
                            <div className="w-20 w-xs-100 align-self-center d-flex justify-content-start justify-content-md-end">
                              <Badge pill color="primary">پیشرفته</Badge>
                            </div>
                          </CardBody>
                        </div>
                      </Card>
